...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PET_DISPLAYED_INDEX = "The pet index provided is invalid. It is larger than the number of showing pets.";
    public static final String MESSAGE_INVALID_SLOT_DISPLAYED_INDEX = "The slot index provided is invalid. It is larger than the number of showing slots.";
